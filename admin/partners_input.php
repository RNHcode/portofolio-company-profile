...
if (isset($_POST['simpan'])) {
    ...
    // print_r($_FILES);
        ...
        if(!in_array($foto_ekstensi,$ekstensi_yang_diperbolehkan)){
            $error = "Ekstensi yang diperbolehkan adalah jpg, jpeg, png dan gif, JPG";
        }
...
if (empty($error)) {
    ...
    if($id != ""){
        $sql1   = "update partners set nama = '$nama',foto='$foto_name',foto='$foto_name',isi='$isi',tgl_isi=now() where id = '$id'";
    }else{

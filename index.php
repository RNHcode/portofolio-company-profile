...
<!-- untuk home -->
<section id="home">
    <img src="<?php echo ambil_gambar('17') ?>" />
    <div class="kolom">
        <p class="deskripsi">
            <?php echo ambil_kutipan('17') ?>
        </p>
        <h2>
            <?php echo ambil_judul('17') ?>
        </h2>
        <?php echo maximum_kata(ambil_isi('17'), 30) ?>
...
<section id="courses">
    <div class="kolom">
        <p class="deskripsi">
            <?php echo ambil_kutipan('3') ?>
        </p>
        <h2>
            <?php echo ambil_judul('3') ?>
        </h2>
        ...
        <div class="tutor-list">
            ...
            <div class="kartu-tutor">
                <a href="<?php echo buat_link_tutors($r1['id']) ?>">
                    <img src="<?php echo url_dasar() . "/gambar/" . tutors_foto($r1['id']) ?>" alt="">
                    <p>
                        <?php echo $r1['nama'] ?>
                    </p>
                </a>
